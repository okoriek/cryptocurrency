...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'crypto.context_processors.notification',
                'crypto.context_processors.pending',
                'crypto.context_processors.withdrawal',
...
DATABASES = {
    'default': dj_database_url.parse(os.getenv('CRYPTO_DB'))
}
